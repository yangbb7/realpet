...
echo "  REALPET_SUPABASE_PUBLISHABLE_KEY=<publishable-key> REALPET_FFMPEG_PATH=/path/to/verified/ffmpeg REALPET_FFMPEG_SHA256=<sha256> REALPET_FFPROBE_PATH=/path/to/verified/ffprobe REALPET_FFPROBE_SHA256=<sha256> ./build_app.sh"
